...
<section class="cta" style="display: flex; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 100px 20px;">
    <div class="container">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="cliente/perfil.php" class="btn-primary" style="display: inline-block; margin-top: 20px; padding: 15px 35px; text-decoration: none;">
                Ir para a Área de Cliente
            </a>
        <?php else: ?>
            <a href="public/registo.php" class="btn-primary" style="display: inline-block; margin-top: 20px; padding: 15px 35px; text-decoration: none;">
                Criar Conta
            </a>
        <?php endif; ?>
